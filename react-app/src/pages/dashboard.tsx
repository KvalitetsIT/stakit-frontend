import { AlertColor, Typography, Card, Grid, List, ListItem, ListItemButton, Tooltip, IconButton, SpeedDial, SpeedDialIcon, LinearProgress, Box, CardContent, CardHeader, CardActionArea, Paper, Avatar, ListItemAvatar, ListItemText } from "@mui/material"
            ...
            <Grid container spacing={2}>
                <Grid item xs={12} lg={6}>
                    ...
                    {mock.groups.map(serviceGroup => (
                        <Paper sx={{ mt: 2 }}>
                            <GroupAccordion group={serviceGroup} />
                        </Paper>
                    ))}
                    <Subscibe></Subscibe>
                </Grid>
